  ...
  const FeedBackForm = ({
    ...
    const submitReview = () => {
      ...
      if (rating === 0) {
        ...
        isValid = false;
        validationOnSubmit('rating', '__ERROR_CHATBOT_RATING__');
      }
    //   if (review == '') {
    //     isValid = false;
    ...
    //   }
      ...
      if (isValid) {
        postAuthReq('/user/chatbot-review', body)
          .then((res: any) => {
            setreview('');
            setrating(0);
            ...
            <View>
              <View style={{marginTop: 20, alignItems: 'center'}}>
                <TextTranslation
                  ...
                  text={translate('__GIVE_FEEDBACK__')}
                />
                {error && (
                  <TextTranslation
                    style={[
              ...
              <View style={{paddingHorizontal: 16, paddingTop: 40}}>
                <TextTranslation
                  ...
                  text={'__Write_your_feedback__'}
                />
                <View style={styles.review}>
                  <TextInput
                  placeholderTextColor={'#7E7E7E'}
                  style={{color:'#7E7E7E',fontFamily:'Avenir Medium',fontSize:16,fontWeight:'500',lineHeight:24}}
                    placeholder={translate('__FEEDBACK_CHATBOT_PLACEHOLDER__')}
                    multiline={true}
