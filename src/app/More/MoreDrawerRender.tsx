...
const MoreDrawerRender = () => {
  ...
  const logout = async () => {
    ...
    postAuthReq('auth/logout', {})
      .then(async data => {
       const solar_auth_Token = await AsyncStorage.getItem('solar_auth_Token');
        await AsyncStorage.clear();
       if(solar_auth_Token){
        setLocalStorage('solar_auth_Token',solar_auth_Token);
       }
          ...
          <ScrollView
            ...
            {isLoggedInStatus ? (
              <>
                ...
                <Pressable
                  ...
                  <CommanView
                    Icon={<OrderIcon width={34} height={34} />}
                    text={'__MYORDERS__'}
                  />
                </Pressable>
              </>
            ...
            {!isLoggedInStatus ? (
              <Pressable
                ...
                <CommanView
                  Icon={<SignUpIcon width={34} height={34} />}
                  text={'__SIGNUP__'}
                />
              </Pressable>
            ) : null}
            ...
            <Pressable
              ...
              <CommanView
                Icon={<HelpIcon width={34} height={34} />}
                text={'__HELP__'}
              />
            </Pressable>
            <Pressable onPress={rateApp}>
              <CommanView
                Icon={<RateIcon width={34} height={34} />}
                text={'__RATETHEAPP__'}
              />
            </Pressable>
            <Pressable onPress={onShare}>
              <CommanView
                Icon={<ShareIcon width={34} height={34} />}
                text={'__SHARE_APP__'}
              />
            </Pressable>
...
export default React.memo(MoreDrawerRender);
