...
import { Add, ChatBoatActive, CircleWithDotRadio, CircleWithRadio, Remove, RightArrow, ShopingBag, UnFilledStar, YoutubePlay } from '../../../asset/img';
...
const ProductDetailRender = ({
    ...
    const [video_id, setVideoId] = useState<any>(null);
    ...
    function extractYouTubeId(url: any) {
        ...
        return match ? match[1] : null; // Returns the video ID or null if no match
    }
        ...
        getLocalStorageData('currentLangauge').then(lang => {
            ...
            postAuthReq('/product/get-productDetails-new', {
                ...
                .then(data => {
                    ...
                    if (data?.data?.data?.productDetails?.product_video) {
                        console.log('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$', data?.data?.data?.productDetails?.product_video)
                        if (extractYouTubeId(data?.data?.data?.productDetails.product_video)) {
                            setVideoId(extractYouTubeId(data?.data?.data?.productDetails.product_video));
                        }
                    }
            ...
            postAuthReq('/product/get-productImages', { productId: productID }).then(
                data => {
                    // if(producDetail.product_video){
                    data.data.data.productImages.push({ image: 'imageThumbnail' })

                    // }
                    console.log('data.data.data.productImages-------------------------------------------------------------', data.data.data.productImages)
                                    ...
                                    return (
                                        <>
                                            ...
                                            <View
                                                ...
                                                {index == productImages.length - 1 && video_id ? (
                                                    <YoutubeIframe
                                                        height={height * 0.30}
                                                        width={width}
                                                        videoId={video_id} // Use YouTube video ID
                                                        play={false} // Autoplay control
                                                    />) :
                                                    <FastImage
                                        ...
                                        renderItem={(item: any) => {
                                            return (
                                                <>
                                                        ...
                                                        {item.index == productImages.length - 1 && video_id ?
                                                        <Pressable
                                                        style={[
                                                            styles.thumbnail,
                                                            {
                                                        ...
                                                        onPress={() => scroll(item.index)}>
                                                            <YoutubePlay width={43} height={activeIndex == item.index ? 41 : 43} />
                                                            </Pressable>
                                                            : null}

                                                        {item.index != productImages.length - 1 ?
                                                        <Pressable
                                                        style={[
                                                            styles.thumbnail,
                                                            {
