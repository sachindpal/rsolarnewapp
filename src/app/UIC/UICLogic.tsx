...
import UICSkeletonLoader from './component/UICSkeletonLoader';
import UICNumberScreen from './UICNumberScreen/UICNumberScreen';
import {of} from 'rxjs';
import { useIsFocused } from '@react-navigation/native';

const UICLogic = (props: any) => {
  ...
  const getUICDetails = () => {
    getAuthReq('/uic/uic-details-new')
      .then(res => {
