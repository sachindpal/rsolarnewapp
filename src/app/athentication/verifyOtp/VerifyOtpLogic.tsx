...
const VerifyOtpLogic = (props: any) => {
    ...
    const apiCallForSignUpSubmitOTP = async () => {
        ...
        await postAuthReq('/auth/verify-otp', formData).then((res: any) => {
            let result = res.data
    ...
    return (
        <VerifyOtpRender submitOTP={submitOTP} validateValue={validateValue} handleChangeOTP={handleChangeOTP} otp={otp} formError={formError} currentLang={currentLang} resendOtp={resendOtp} setresendOtp={setresendOtp} resendHandler={resendHandler} inputs={inputs} mobileNum={props.route.params.mobile} isloading={isloading}/>
    )
}
