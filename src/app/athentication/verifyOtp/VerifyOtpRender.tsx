...
const VerifyOtpRender = (props: dataType) => {
            ...
            <View style={styles.mainFormView}>
                <View style={styles.formView}>
                    <View style={{ alignItems: "center", paddingTop: 16 }}>
                        <TextTranslation style={FontStyle.fontMedium22} text={'__ENTER_OTP__'} />
                    </View>
                    <View style={{}}>
                        <View style={{ paddingTop: 16, paddingBottom: 24, paddingHorizontal: 8 }}>
                            {props.currentLang == "en" ? <><Text
                        ...
                        <View style={{ paddingTop: 24 }}>
                            ...
                            <Button title='__SUBMIT__' loader={props.isloading} disableBtn={props.isloading} bgGreen onPress={props.submitOTP} fontSize={16} />
                        </View>
...
export default VerifyOtpRender
